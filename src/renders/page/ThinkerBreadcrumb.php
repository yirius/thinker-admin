 ...
 */
class ThinkerBreadcrumb extends LayoutAbstract
{
    /**
     * @var string
     */
    ...
    public function render()
    {
        ...
        for($i = 0; $i < count($this->breadcrumbs); $i++){
            if(empty($this->breadcrumbs[$i]['value'])){
                ...
                $layouts[] = '<a lay-href="' . $this->breadcrumbs[$i]['value'] . '"><cite>' . $this->breadcrumbs[$i]['text'] . '</cite></a>';
            }
        }
